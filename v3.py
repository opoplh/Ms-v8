...
class ManageView(discord.ui.View):
    ...
    def add_action_buttons(self):
        start_button = discord.ui.Button(label="Start VPS", style=discord.ButtonStyle.green, emoji="🟢")
        start_button.callback = lambda inter: self.action_callback(inter, 'start')
        stop_button = discord.ui.Button(label="Stop VPS", style=discord.ButtonStyle.red, emoji="🔴")
        stop_button.callback = lambda inter: self.action_callback(inter, 'stop')
        tmate_button = discord.ui.Button(label="Tmate SSH", style=discord.ButtonStyle.blurple, emoji="🔗")
...
async def show_plans(ctx):
    ...
    embed = discord.Embed(title="Hycroe Node V3 – VPS Plans", color=0x0099ff)
    embed.add_field(
        name="Starter",
        value="RAM: 4 GB\nCPU: 1 Core\nStorage: 10 GB\nCredits: Intel : ₹42 / AMD : ₹83",
        inline=False
    )
    embed.add_field(
        name="Basic",
        value="RAM: 8 GB\nCPU: 1 Core\nStorage: 10 GB\nCredits: Intel : ₹96 / AMD : ₹164",
        inline=False
    )
    embed.add_field(
        name="Standard",
        value="RAM: 12 GB\nCPU: 2 Cores\nStorage: 10 GB\nCredits: Intel : ₹192 / AMD : ₹320",
        inline=False
    )
    embed.add_field(
        name="Pro",
        value="RAM: 16 GB\nCPU: 2 Cores\nStorage: 10 GB\nCredits: Intel : ₹220 / AMD : ₹340",
        inline=False
    )
    await ctx.send(embed=embed)
